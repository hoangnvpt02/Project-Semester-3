<template>
  <div>
	...
	<header id="fh5co-header" class="fh5co-cover fh5co-cover-sm" role="banner" :style="{ backgroundImage: `url(${img_bg_2})` }">
		...
		<div class="container">
			<div class="about-content">
				<div class="row animate-box">
					...
					<div class="col-md-6">
						<img class="img-responsive" src="../../assets/images/bg1.jpg" alt="about">
					</div>
				</div>
			</div>
			<div class="row animate-box">
